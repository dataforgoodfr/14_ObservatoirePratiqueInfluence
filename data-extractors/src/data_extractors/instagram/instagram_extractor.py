...
class InstagramExtractor(DataExtractor):
    def extract_account(
        ...
        raise Exception("InstagramDataExtractor.extract_account not implemented yet")

    def extract_post_list(
        self, task_config: ExtractPostListTaskConfig
    ) -> PostListExtractionResult:
        raise Exception("InstagramDataExtractor.extract_post_list not implemented yet")

    def extract_post_details(
        self, task_config: ExtractPostDetailsTaskConfig
    ) -> PostDetailsExtractionResult:
        raise Exception(
            "InstagramDataExtractor.extract_post_detail not implemented yet"
        )
